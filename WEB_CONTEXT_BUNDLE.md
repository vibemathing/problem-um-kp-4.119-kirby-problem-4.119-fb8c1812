...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.119-kirby-problem-4.119-fb8c1812-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.119"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.119-kirby-problem-4.119-fb8c1812-v1",
      "problem_contract_sha256": "6b369b7de1d70a2fe7195133b2f2239489535b9af155f997943ee5efb6caad49",
      "problem_id": "problem:um-kp-4.119-kirby-problem-4.119-fb8c1812",
      "route_id": "route:um-kp-4.119-kirby-problem-4.119-fb8c1812-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.119-kirby-problem-4.119-fb8c1812-source-fidelity-01",
      "graph_id": "graph:um-kp-4.119-kirby-problem-4.119-fb8c1812-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.119-kirby-problem-4.119-fb8c1812-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.119-kirby-problem-4.119-fb8c1812-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is every topological 4-manifold homeomorphic to a CW complex?"
          },
          "statement_sha256": "decef14e3d03cfcb380463f8cfc0f78685e8bb7fa6b8d368195092f7fa0d327e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.119-kirby-problem-4.119-fb8c1812-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.119-kirby-problem-4.119-fb8c1812-root",
      "route_id": "route:um-kp-4.119-kirby-problem-4.119-fb8c1812-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.119-fc59d6de3540",
        "url": "https://www.unsolvedmath.com/problems/KP-4.119"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
